...
TEST_F(QarserTest, LexerTest_QASM1) {
...
TEST_F(QarserTest, ParserTest_QASM1) {
...
TEST_F(QarserTest, SemanticAnalyzerTest_QASM1) {
    qarser::Parser parser(debug_qasm1);
    auto ast = parser.parse();
...
TEST_F(QarserTest, DAGConverterTest_QASM2) {
