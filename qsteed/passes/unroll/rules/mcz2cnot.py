...
class MCZToCNOT(UnrollPass):
    """The MCZToCNOT pass.
    convert MCZ gate to {CNOT, CP}.

    MCZ gate decomposition rule(control bit 0:2, target bit: 3, ancilla bit: None):
    q[0]  --*--      q[0]  ---------------------------------+----*-----+----*----+-----*----+----*--------
            |                                               |    |     |    |    |     |    |    |
    q[1]  --*--  ≡   q[1]  -------------+----*----+----*----*----|-----|----|----*-----|----|----|--------
            |                           |    |    |    |         |     |    |          |    |    |
    q[2]  --*--      q[2]  -------*-----*----|----*----|---------|-----*----|----------|----*----|--------
            |                     |          |         |         |          |          |         |  
    q[3]  --X--      q[3]  -------R1--------R1_--------R1--------R1_--------R1--------R1_--------R1------- 
    ...
    def run(self, op: Instruction) -> List[Instruction]:
        ...
        if isinstance(op, MCZGate):
            ...
            if len(control_bits) == 1:
                rule.append(CZGate(control_bits[0], target_bit))
